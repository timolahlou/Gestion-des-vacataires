<?php  include "../view/layout/head.php";  ?>
    ...
    <td><?php if ($c->ID_VALIDE_COURS == 1) { echo "Validé"; }else{ echo "non validé"; } ?><button type="button" class="btn btn-success btn-xs btn-lg"><span class="glyphicon glyphicon-ok"></span></button></td>
